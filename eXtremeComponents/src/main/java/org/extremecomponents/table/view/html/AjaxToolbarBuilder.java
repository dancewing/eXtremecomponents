...
import org.extremecomponents.table.view.html.toolbar.ajax.AjaxImageItem;
import org.extremecomponents.util.HtmlBuilder;

/**
 * @author Jeff Johnston
 */
public class AjaxToolbarBuilder {
    private HtmlBuilder html;
    private TableModel model;
    private Messages messages;

    public AjaxToolbarBuilder(TableModel model) {
        this(new HtmlBuilder(), model);
    }

    public AjaxToolbarBuilder(HtmlBuilder html, TableModel model) {
        this.html = html;
        this.model = model;
    ...
    public void firstPageItemAsImage() {
        ImageItem item = new AjaxImageItem();
        item.setId(model.getTableHandler().prefixWithTableId() + BuilderConstants.TOOLBAR_FIRST_PAGE_IMAGE);
        item.setTooltip(messages.getMessage(BuilderConstants.TOOLBAR_FIRST_PAGE_TOOLTIP));
