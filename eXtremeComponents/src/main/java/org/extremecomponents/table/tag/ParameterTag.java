...
public class ParameterTag extends TagSupport {
    ...
    public int doEndTag() throws JspException {
        try {
            ...
            String name = TagUtils.evaluateExpressionAsString("name", this.name, pageContext);
            Object value = TagUtils.evaluateExpressionAsObject("value", this.value, pageContext);
