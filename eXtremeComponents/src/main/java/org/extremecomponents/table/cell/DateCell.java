...
import org.extremecomponents.util.HtmlUtils;
...
public class DateCell extends AbstractCell {
    ...
    public String getExportDisplay(TableModel model, Column column) {
        return HtmlUtils.htmlEscape(org.extremecomponents.util.StringUtils.trimAllWhitespace(getCellValue(model, column)));
    }
