...
<ec:table dataSource="${dataSource}"
          action="${pageContext.request.contextPath}/single.jsp"
          title="Presidents"
          width="60%"
          rowsDisplayed="5" filterable="true" var="t" tableId="ec_224"
        >
...
<button onclick="javascript:document.forms.ec_224.ec_eti.value='ec_224';document.forms.ec_224.ec_224_ev.value='html';document.forms.ec_224.ec_224_efn.value='Test.html';document.forms.ec_224.setAttribute('action','/single.jsp');document.forms.ec_224.setAttribute('method','post');document.forms.ec_224.submit()">Click</button>
<br>
